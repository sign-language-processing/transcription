...
class JoinSignsCase(unittest.TestCase):
    ...
    def test_join_alphabet_characters(self):
        ...
        self.assertEqual(result_sign, 'M500x500S1f720490x362S14720493x387S16d20492x419S10120492x449S14a20493x489S1ce20489x514S1f000486x554S11502485x579S19220490x604S19220498x649S2a20c482x633')
