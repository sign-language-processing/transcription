...
parser.add_argument('--only_optical_flow', type=bool, default=False, help='Should we use only optical flow?')
...
parser.add_argument('--weighted_loss', type=bool, default=True, help='should use a class weighted loss?')
