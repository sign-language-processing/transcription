...
#  pigz >"${output_prefix}.${lang}.nrm.gz"
  cp "${input_prefix}.${lang}.gz" "${output_prefix}.${lang}.nrm.gz"
...
#  pigz >"${output_prefix}.${lang}.langid.gz"
  cp "${output_prefix}.${lang}.monofix.gz" "${output_prefix}.${lang}.langid.gz"
...
cp "${output_prefix}.${lang}.langid.gz" "${output_prefix}.${lang}.gz"
