...
#    pigz >"${output_prefix}.${lng}.nrm.gz"
    cp "${input_prefix}.${lng}.gz" "${output_prefix}.${lng}.nrm.gz"
done
...
#  pigz >"${output_prefix}.${SRC}${TRG}.rule-based.gz"
  cp "${output_prefix}.${SRC}${TRG}.fix.gz" "${output_prefix}.${SRC}${TRG}.rule-based.gz"
...
#  pigz >"${output_prefix}.${SRC}${TRG}.langid.gz"
  cp "${output_prefix}.${SRC}${TRG}.rule-based.gz" "${output_prefix}.${SRC}${TRG}.langid.gz"
######################################################################
