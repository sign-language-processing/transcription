...
BOOKS = {'Genesis': 'GEN', 'Exodus': 'EXO', 'Leviticus': 'LEV', 'Numbers': 'NUM', 'Deuteronomy': 'DEU', 'Joshua': 'JOS',
         ...
         'Psalms': 'PSA', 'Psalm': 'PSA', 'Proverbs': 'PRO', 'Proverb': 'PRO', 'Provrerbs': 'PRO', 'Provertbs': 'PRO',
         'Ecclesiastes': 'ECC',
         'Song of Solomon': 'SON', 'Isaiah': 'ISA',
         'Jeremiah': 'JER', 'Lamentations': 'LAM', 'Lamentaions': 'LAM', 'Ezekiel': 'EZE', 'Daniel': 'DAN',
         'Hosea': 'HOS', 'Joel': 'JOE',
         'Amos': 'AMO', 'Obadiah': 'OBA', 'Jonah': 'JON', 'Micah': 'MIC', 'Nahum': 'NAH', 'Habakkuk': 'HAB',
         'Zephaniah': 'ZEP', 'Haggai': 'HAG', 'Zechariah': 'ZEC', 'Malachi': 'MAL', 'Matthew': 'MAT', 'Mark': 'MAR',
         'Luke': 'LUK', 'John': 'JOH', 'Acts': 'ACT', 'Romans': 'ROM', '1 Corinthians': '1CO', '1Cor': '1CO',
         '1 Corinthinans': '1CO', '1 Corinthinan': '1CO',
         '2 Corinthians': '2CO', '2Co': '2CO',
         'Galatians': 'GAL', 'Ephesians': 'EPH', 'Philippians': 'PHI', 'Colossians': 'COL', '1 Thessalonians': '1TH',
         '1 Thessolonians': '1TH',
         '2 Thessalonians': '2TH', '1 Timothy': '1TI', '1Timothy': '1TI', '2 Timothy': '2TI', 'Titus': 'TIT',
         'Philemon': 'PHM',
         'Hebrews': 'HEB', 'James': 'JAM', '1 Peter': '1PE', '1Pe': '1PE', '2 Peter': '2PE', '1 John': '1JO',
         '1 Joh': '1JO',
         '2 John': '2JO',
...
for lang, verses in verse_dict.items():
    text = "\n".join([("<" + lang + "> " + verses[key]) if key in verses else "" for key in all_keys])
