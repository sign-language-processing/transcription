...
class DetokenizeCase(unittest.TestCase):
    def test_detokenization_single_sign(self):
        ...
        tokens = ['M', 'p123', 'p456', 'S1f7', 'c2', 'r0', 'p487', 'p492', 'S1f7', 'c2', 'r0', 'p487', 'p492']
        fsw = tokenizer.convert_tokens_to_string(tokens)
        self.assertEqual(fsw, 'M123x456S1f720487x492S1f720487x492')

    def test_detokenization_multiple_signs(self):
        tokenizer = SignLanguageTokenizer()

        tokens = ['M', 'p123', 'p456', 'S1f7', 'c2', 'r0', 'p487', 'p492', 'M', 'p124', 'p456', 'S1f2', 'c1',
                  'r0', 'p488', 'p493']
        fsw = tokenizer.convert_tokens_to_string(tokens)
        self.assertEqual(fsw, 'M123x456S1f720487x492 M124x456S1f210488x493')
